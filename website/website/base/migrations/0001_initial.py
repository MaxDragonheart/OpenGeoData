    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_description', models.CharField(blank=True, default='Ufficio Tecnico Comunale e SIT.', max_length=100, null=True)),
                ('address', models.TextField(blank=True, default='Via della Costituzione, 1, - Città dei Sogni, 9999888', null=True)),
                ('contact_phone', models.CharField(blank=True, default='+39 0987543', max_length=250, null=True)),
                ('contact_email', models.EmailField(blank=True, default='mail@email.sito', max_length=254, null=True)),
                ('contact_official_email', models.EmailField(blank=True, default='pec-mail@email.sito', max_length=254, null=True)),
